...
login_data = {
    "username": "dnng", # đổi thành username acc mcserver vào đây
    "email": "", # hoặc dùng mail để mail thì thôi username 
    "password": {
        "value": "hoilamchi", # password điền vào 
        "repeat": ""
    }
}
login_url = "https://www.mcserverhost.com/api/login"
sub_url = "https://www.mcserverhost.com/api/servers/b864f512/subscription" # dán vào đây 
def run_automation():
